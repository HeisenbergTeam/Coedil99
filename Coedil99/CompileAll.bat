...
"%_JAVACCMD%" -encoding UTF-8 -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\com\coedil99\modello_di_dominio\*.java %_SOURCEPATH%\com\coedil99\modello_di_dominio\impl\*.java %_SOURCEPATH%\com\coedil99\modello_di_dominio\dao\*.java %_SOURCEPATH%\ormsamples\*.java 
