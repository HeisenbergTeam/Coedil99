...
public class CommessaDAOImpl implements modello_di_dominio.dao.CommessaDAO {
	...
	public Commessa loadCommessaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Commessa) session.load(modello_di_dominio.Commessa.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Commessa getCommessaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Commessa) session.get(modello_di_dominio.Commessa.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Commessa loadCommessaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Commessa) session.load(modello_di_dominio.Commessa.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Commessa getCommessaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Commessa) session.get(modello_di_dominio.Commessa.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryCommessa(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Commessa as Commessa");
		if (condition != null)
	...
	public Commessa createCommessa() {
		return new modello_di_dominio.Commessa();
	}
	
	public boolean save(modello_di_dominio.Commessa commessa) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(commessa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.Commessa commessa) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(commessa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(modello_di_dominio.Commessa commessa) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(commessa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.Commessa commessa) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(commessa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
