...
public interface ORMConstants extends org.orm.util.ORMBaseConstants {
    ...
    final int KEY_DESCRIZIONEPEZZO_FORNITORE = 1752647710;
    ...
    final int KEY_FORNITORE_DESCRIZIONEPEZZO = -998308968;

    final int KEY_FORNITORE_RDA = 1836245698;
    ...
    final int KEY_PEZZO_RIGARDA = 265104665;

    final int KEY_RDA_FORNITORE = 1419416642;

    final int KEY_RDA_RIGHERDA = -1173257966;

    final int KEY_RIGADISTINTA_DISTINTA = 760781550;

    final int KEY_RIGADISTINTA_LAVORAZIONEPEZZO = 444202454;

    final int KEY_RIGADISTINTA_PEZZO = 1183962340;

    final int KEY_RIGARDA_PEZZO = 844342489;

    final int KEY_RIGARDA_RDA = 1355068910;
