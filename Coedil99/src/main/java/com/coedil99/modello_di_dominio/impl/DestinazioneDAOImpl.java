...
public class DestinazioneDAOImpl implements DestinazioneDAO {
	...
	public Destinazione loadDestinazioneByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Destinazione) session.load(Destinazione.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione getDestinazioneByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Destinazione) session.get(Destinazione.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione loadDestinazioneByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Destinazione) session.load(Destinazione.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione getDestinazioneByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Destinazione) session.get(Destinazione.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryDestinazione(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Destinazione as Destinazione");
		if (condition != null)
	...
	public boolean save(Destinazione destinazione) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().saveObject(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(Destinazione destinazione) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().deleteObject(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(Destinazione destinazione) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().getSession().refresh(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(Destinazione destinazione) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().getSession().evict(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
