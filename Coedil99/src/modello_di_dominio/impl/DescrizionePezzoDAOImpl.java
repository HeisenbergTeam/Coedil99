...
public class DescrizionePezzoDAOImpl implements modello_di_dominio.dao.DescrizionePezzoDAO {
	...
	public DescrizionePezzo loadDescrizionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (DescrizionePezzo) session.load(modello_di_dominio.DescrizionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo getDescrizionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (DescrizionePezzo) session.get(modello_di_dominio.DescrizionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo loadDescrizionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (DescrizionePezzo) session.load(modello_di_dominio.DescrizionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo getDescrizionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (DescrizionePezzo) session.get(modello_di_dominio.DescrizionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryDescrizionePezzo(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.DescrizionePezzo as DescrizionePezzo");
		if (condition != null)
	...
	public static java.util.Iterator iterateDescrizionePezzoByQuery(String condition, String orderBy) throws PersistentException {
		try {
			PersistentSession session = modello_di_dominio.Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateDescrizionePezzoByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = modello_di_dominio.Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateDescrizionePezzoByQuery(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.DescrizionePezzo as DescrizionePezzo");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static java.util.Iterator iterateDescrizionePezzoByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.DescrizionePezzo as DescrizionePezzo");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public DescrizionePezzo createDescrizionePezzo() {
		return new modello_di_dominio.DescrizionePezzo();
	}
	
	public boolean save(modello_di_dominio.DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(modello_di_dominio.DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
