...
public class DescrizionePezzoDAOImpl implements DescrizionePezzoDAO {
	...
	public DescrizionePezzo loadDescrizionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (DescrizionePezzo) session.load(DescrizionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo getDescrizionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (DescrizionePezzo) session.get(DescrizionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo loadDescrizionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (DescrizionePezzo) session.load(DescrizionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public DescrizionePezzo getDescrizionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (DescrizionePezzo) session.get(DescrizionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryDescrizionePezzo(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From DescrizionePezzo as DescrizionePezzo");
		if (condition != null)
	...
	public DescrizionePezzo createDescrizionePezzo() {
		return new DescrizionePezzo();
	}
	
	public boolean save(DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().saveObject(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().deleteObject(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().getSession().refresh(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(DescrizionePezzo descrizionePezzo) throws PersistentException {
		try {
			Coedil99PersistentManager.instance().getSession().evict(descrizionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
