...
CREATE TABLE Pezzo (ID int(11) NOT NULL AUTO_INCREMENT, Quantita int(11), DescrizionePezzoID int(11) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB;
...
CREATE TABLE RDA (ID int(11) NOT NULL AUTO_INCREMENT, FornitoreID int(11) NOT NULL, Descrizione varchar(255), DataCreazione date, DataArrivoPrevista date, DataArrivoEffettiva date, PRIMARY KEY (ID)) ENGINE=InnoDB;
