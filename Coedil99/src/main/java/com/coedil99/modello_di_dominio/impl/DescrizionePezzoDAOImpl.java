...
public class DescrizionePezzoDAOImpl implements DescrizionePezzoDAO {
    ...
    public List queryDescrizionePezzo(String condition, String orderBy, LockMode lockMode) throws PersistentException {
        try {
            PersistentSession session = Coedil99PersistentManager.instance().getSession();
    ...
    public List queryDescrizionePezzo(PersistentSession session, String condition, String orderBy) throws PersistentException {
        StringBuffer sb = new StringBuffer("From modello_di_DescrizionePezzo as DescrizionePezzo");
        if (condition != null)
    ...
    public List queryDescrizionePezzo(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
        StringBuffer sb = new StringBuffer("From modello_di_DescrizionePezzo as DescrizionePezzo");
        if (condition != null)
            sb.append(" Where ").append(condition);
        if (orderBy != null)
