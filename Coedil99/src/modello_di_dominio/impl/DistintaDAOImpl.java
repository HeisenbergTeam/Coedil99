...
public class DistintaDAOImpl implements modello_di_dominio.dao.DistintaDAO {
	...
	public Distinta loadDistintaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Distinta) session.load(modello_di_dominio.Distinta.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Distinta getDistintaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Distinta) session.get(modello_di_dominio.Distinta.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Distinta loadDistintaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Distinta) session.load(modello_di_dominio.Distinta.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Distinta getDistintaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Distinta) session.get(modello_di_dominio.Distinta.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryDistinta(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Distinta as Distinta");
		if (condition != null)
	...
	public Distinta createDistinta() {
		return new modello_di_dominio.Distinta();
	}
	
	public boolean save(modello_di_dominio.Distinta distinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(distinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.Distinta distinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(distinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteAndDissociate(modello_di_dominio.Distinta distinta)throws PersistentException {
		try {
			...
			modello_di_dominio.RigaDistinta[] lRigheDistintas = distinta.righeDistinta.toArray();
	...
	public boolean refresh(modello_di_dominio.Distinta distinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(distinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.Distinta distinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(distinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
