...
public class LavorazionePezzoDAOImpl implements LavorazionePezzoDAO {
	...
	public List queryLavorazionePezzo(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From LavorazionePezzo as LavorazionePezzo");
		if (condition != null)
	...
	public static java.util.Iterator iterateLavorazionePezzoByQuery(String condition, String orderBy) throws PersistentException {
		try {
			PersistentSession session = Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateLavorazionePezzoByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateLavorazionePezzoByQuery(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From LavorazionePezzo as LavorazionePezzo");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static java.util.Iterator iterateLavorazionePezzoByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From LavorazionePezzo as LavorazionePezzo");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public boolean deleteAndDissociate(LavorazionePezzo lavorazionePezzo, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(lavorazionePezzo.getSagoma() != null) {
				lavorazionePezzo.getSagoma().setLavorazionePezzo(null);
			}
