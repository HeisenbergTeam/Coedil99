...
public class RigaDistintaDAOImpl implements modello_di_dominio.dao.RigaDistintaDAO {
	...
	public RigaDistinta loadRigaDistintaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (RigaDistinta) session.load(modello_di_dominio.RigaDistinta.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public RigaDistinta getRigaDistintaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (RigaDistinta) session.get(modello_di_dominio.RigaDistinta.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public RigaDistinta loadRigaDistintaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (RigaDistinta) session.load(modello_di_dominio.RigaDistinta.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public RigaDistinta getRigaDistintaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (RigaDistinta) session.get(modello_di_dominio.RigaDistinta.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryRigaDistinta(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.RigaDistinta as RigaDistinta");
		if (condition != null)
	...
	public RigaDistinta createRigaDistinta() {
		return new modello_di_dominio.RigaDistinta();
	}
	
	public boolean save(modello_di_dominio.RigaDistinta rigaDistinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(rigaDistinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.RigaDistinta rigaDistinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(rigaDistinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(modello_di_dominio.RigaDistinta rigaDistinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(rigaDistinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.RigaDistinta rigaDistinta) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(rigaDistinta);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
