...
public class CommessaDAOImpl implements CommessaDAO {
    ...
    public Commessa loadCommessaByORMID(PersistentSession session, int ID) throws PersistentException {
        try {
            return (Commessa) session.load(Commessa.class, new Integer(ID));
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Commessa getCommessaByORMID(PersistentSession session, int ID) throws PersistentException {
        try {
            return (Commessa) session.get(Commessa.class, new Integer(ID));
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Commessa loadCommessaByORMID(PersistentSession session, int ID, LockMode lockMode) throws PersistentException {
        try {
            return (Commessa) session.load(Commessa.class, new Integer(ID), lockMode);
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Commessa getCommessaByORMID(PersistentSession session, int ID, LockMode lockMode) throws PersistentException {
        try {
            return (Commessa) session.get(Commessa.class, new Integer(ID), lockMode);
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public List queryCommessa(PersistentSession session, String condition, String orderBy) throws PersistentException {
        StringBuffer sb = new StringBuffer("From modello_di_Commessa as Commessa");
        if (condition != null)
    ...
    public boolean save(Commessa commessa) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().saveObject(commessa);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean delete(Commessa commessa) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().deleteObject(commessa);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean refresh(Commessa commessa) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().getSession().refresh(commessa);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean evict(Commessa commessa) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().getSession().evict(commessa);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
