...
public class LavorazionePezzoDAOImpl implements modello_di_dominio.dao.LavorazionePezzoDAO {
	...
	public LavorazionePezzo loadLavorazionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (LavorazionePezzo) session.load(modello_di_dominio.LavorazionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public LavorazionePezzo getLavorazionePezzoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (LavorazionePezzo) session.get(modello_di_dominio.LavorazionePezzo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public LavorazionePezzo loadLavorazionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (LavorazionePezzo) session.load(modello_di_dominio.LavorazionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public LavorazionePezzo getLavorazionePezzoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (LavorazionePezzo) session.get(modello_di_dominio.LavorazionePezzo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryLavorazionePezzo(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.LavorazionePezzo as LavorazionePezzo");
		if (condition != null)
	...
	public LavorazionePezzo createLavorazionePezzo() {
		return new modello_di_dominio.LavorazionePezzo();
	}
	
	public boolean save(modello_di_dominio.LavorazionePezzo lavorazionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(lavorazionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.LavorazionePezzo lavorazionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(lavorazionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.LavorazionePezzo lavorazionePezzo) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(lavorazionePezzo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
