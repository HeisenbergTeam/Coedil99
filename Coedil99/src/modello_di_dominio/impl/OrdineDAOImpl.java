...
public class OrdineDAOImpl implements modello_di_dominio.dao.OrdineDAO {
	...
	public Ordine loadOrdineByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Ordine) session.load(modello_di_dominio.Ordine.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Ordine getOrdineByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Ordine) session.get(modello_di_dominio.Ordine.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Ordine loadOrdineByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ordine) session.load(modello_di_dominio.Ordine.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Ordine getOrdineByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ordine) session.get(modello_di_dominio.Ordine.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryOrdine(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Ordine as Ordine");
		if (condition != null)
	...
	public Ordine createOrdine() {
		return new modello_di_dominio.Ordine();
	}
	
	public boolean save(modello_di_dominio.Ordine ordine) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(ordine);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.Ordine ordine) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(ordine);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh(modello_di_dominio.Ordine ordine) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(ordine);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.Ordine ordine) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(ordine);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
