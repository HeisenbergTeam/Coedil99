...
public class FornitoreDAOImpl implements FornitoreDAO {
    ...
    public Fornitore loadFornitoreByORMID(PersistentSession session, int ID) throws PersistentException {
        try {
            return (Fornitore) session.load(Fornitore.class, new Integer(ID));
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Fornitore getFornitoreByORMID(PersistentSession session, int ID) throws PersistentException {
        try {
            return (Fornitore) session.get(Fornitore.class, new Integer(ID));
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Fornitore loadFornitoreByORMID(PersistentSession session, int ID, LockMode lockMode) throws PersistentException {
        try {
            return (Fornitore) session.load(Fornitore.class, new Integer(ID), lockMode);
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public Fornitore getFornitoreByORMID(PersistentSession session, int ID, LockMode lockMode) throws PersistentException {
        try {
            return (Fornitore) session.get(Fornitore.class, new Integer(ID), lockMode);
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
        }
    ...
    public List queryFornitore(PersistentSession session, String condition, String orderBy) throws PersistentException {
        StringBuffer sb = new StringBuffer("From modello_di_Fornitore as Fornitore");
        if (condition != null)
    ...
    public boolean save(Fornitore fornitore) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().saveObject(fornitore);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean delete(Fornitore fornitore) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().deleteObject(fornitore);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean deleteAndDissociate(Fornitore fornitore) throws PersistentException {
        try {
            RDA[] lRdas = fornitore.rda.toArray();
            for (int i = 0; i < lRdas.length; i++) {
                lRdas[i].setFornitore(null);
            }
            DescrizionePezzo[] lDescrizionePezzos = fornitore.descrizionePezzo.toArray();
    ...
    public boolean refresh(Fornitore fornitore) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().getSession().refresh(fornitore);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public boolean evict(Fornitore fornitore) throws PersistentException {
        try {
            Coedil99PersistentManager.instance().getSession().evict(fornitore);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
