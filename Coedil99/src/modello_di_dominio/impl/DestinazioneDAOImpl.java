...
public class DestinazioneDAOImpl implements modello_di_dominio.dao.DestinazioneDAO {
	...
	public Destinazione loadDestinazioneByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Destinazione) session.load(modello_di_dominio.Destinazione.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione getDestinazioneByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Destinazione) session.get(modello_di_dominio.Destinazione.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione loadDestinazioneByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Destinazione) session.load(modello_di_dominio.Destinazione.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Destinazione getDestinazioneByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Destinazione) session.get(modello_di_dominio.Destinazione.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryDestinazione(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Destinazione as Destinazione");
		if (condition != null)
	...
	public static java.util.Iterator iterateDestinazioneByQuery(String condition, String orderBy) throws PersistentException {
		try {
			PersistentSession session = modello_di_dominio.Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateDestinazioneByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = modello_di_dominio.Coedil99PersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateDestinazioneByQuery(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Destinazione as Destinazione");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static java.util.Iterator iterateDestinazioneByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modello_di_dominio.Destinazione as Destinazione");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public Destinazione createDestinazione() {
		return new modello_di_dominio.Destinazione();
	}
	
	public boolean save(modello_di_dominio.Destinazione destinazione) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().saveObject(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(modello_di_dominio.Destinazione destinazione) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().deleteObject(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteAndDissociate(modello_di_dominio.Destinazione destinazione)throws PersistentException {
		try {
	...
	public boolean deleteAndDissociate(modello_di_dominio.Destinazione destinazione, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(destinazione.getOrdine() != null) {
				destinazione.getOrdine().setDestinazione(null);
			}
	...
	public boolean refresh(modello_di_dominio.Destinazione destinazione) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().refresh(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(modello_di_dominio.Destinazione destinazione) throws PersistentException {
		try {
			modello_di_dominio.Coedil99PersistentManager.instance().getSession().evict(destinazione);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
